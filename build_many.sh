...
-I/data/project/ei_development/tools/cuBNM/cuBNM/cpp -D MANY_NODES
...
-lm -lcudart
rm -f libbnm.a
ar cru libbnm.a bnm.o bnm_tmp.o # consider changing the library name to have both libraries
ranlib libbnm.a
